      ...
      <div className="ms-story-wrapper">
        ...
        <div className="ms-vid-card-holder">
          ...
          <div className="ms-vid-frame">
            ...
            {/* PULSING PLAY BUTTON */}
            <button
              className="ms-vid-trigger-btn"
              onClick={() => setIsVideoOpen(true)}
              aria-label="Play Video"
            >
              <div className="ms-vid-pulse-circle ms-circle-1"></div>
              <div className="ms-vid-pulse-circle ms-circle-2"></div>
              <div className="ms-vid-play-icon">
